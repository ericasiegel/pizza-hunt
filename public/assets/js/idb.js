...
// indexedDB.open opens the connection to the database
// indexedDB is a 'window' object and a global variable
// .open() takes in 2 parameters
// 1. the name of the IndexedDB database you'd like to create (if it doesn't exist) or connect to (if it does exist)
// 2. the version of the database. by default, we start at 1. This parameter is used to determine whether the database's structure has changed between connections.
const request = indexedDB.open('pizza_hunt', 1);
// in IndexedDB the container that stores the data is called an 'object store'
// cant create one until the connection is open, emitting an event that the 'request' variable will be able to capture.
